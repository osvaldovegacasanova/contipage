...
export const environmentalImpactSection = {
  title: "Misión",
  subheading1_1: "Continental Blowers Andes en la",
  ...
  impactPoints: [
    ...
    {
      icon: "experience",
      text: "Más de 25 años en la región",
    },
    {
      icon: "processes",
      text: "Procesos: PTAR, biogás, minería e industria",
    },
    {
      icon: "objectives",
      text: "Objetivos: eficiencia, seguridad y continuidad operacional",
    },
  ],
  visual: img,
